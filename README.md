...
This is the official (preliminary) implementation of the SOAP optimizer in the paper \url{https://arxiv.org/abs/2409.11321}. To use, copy the soap.py file to your codebase and use SOAP optimizer in the following fashion:
